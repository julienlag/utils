...
#$ -e $wd/$outFilePrefix.RPKM.q.e
#$ -o $wd/$outFilePrefix.RPKM.q.o
...
date >&2
RPKM_on_starBED.sh -s $bn.bed -a $annfile -o $outFilePrefix 
date >&2
" > $outFilePrefix.RPKM.q;
qsub -q main -N j$bn -l h_vmem=22G $outFilePrefix.RPKM.q
#	else
